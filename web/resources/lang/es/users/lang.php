...
return [
    ...
    'error_en_accion' => 'Error en la acción',
    'cancelar' => 'Cancelar',
    'guardar' => 'Guardar',
    ...
    'password_min' => 'La contraseña no tiene suficientes caracteres.',
    'online' => 'Online',
    ...
    /* Api Token */
    'api_title' => 'Api tokens',
    'token_name' => 'Nombre del token',
    'api_token_obligatorio' => 'El nombre del token es obligatorio',
    'api_tokens' => 'API Tokens',
    'token' => 'Token',
    'create_api_token' => 'Create API Tokens',
    'create_api_token_info' => 'Los API tokens permiten que los servicios de terceros se autentíquen en nuestra aplicación en nuestro nombre.',
    'manage_api_tokens' => 'Administrar API tokens',
    'manage_api_tokens_info' => 'Puedes eliminar cualquiera de tus tokens existentes si ya no los necesita.',
    'token_delete_question' => '¿Está seguro que desea borrar este token?. No podran acceder remotamente si está en uso.',
    'okUpdate_api' => 'Se han guardado correctamente el token del usuario.',
    ...
    'tratamiento' => 'Tratamiento de Información',
