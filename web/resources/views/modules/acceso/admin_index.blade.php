        ...
        <div class="col-12">
            <div class="card card-secondary card-outline">
                <div class="card-header with-border">
                    <h3 class="card-title">{{ trans("acceso/lang.listado_accesos") }}</h3>
                </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header"><h3 class="card-title">{{ trans("acceso/lang.export") }}</h3></div>

                <div class="card-body">

                    <a href="{{ url('admin/acceso/generateExcel') }}" class="btn btn-app">
                        <i class="far fa-file-excel-o" aria-hidden="true"></i>
