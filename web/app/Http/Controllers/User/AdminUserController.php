...
{
    protected $page_title_icon = '<i class="fas fa-user" aria-hidden="true"></i>';
        ...
        return Datatables::of($users)
            ->editColumn('active', function ($data) {
                return '<button class="btn ' . ($data->active ? "btn-success" : "btn-danger") . ' btn-sm" ' .
                    (auth()->user()->isAbleTo("admin-users-update") ? "onclick=\"javascript:changeStatus('" .
            ...
            ->addColumn('actions', function ($data) {
                ...
                if (auth()->user()->isAbleTo("admin-users-suplantar")) {
                    $actions .= '&nbsp;<button class="btn bg-info btn-sm" onclick="javascript:suplantarElement(\'' .
                        url('admin/users/suplantar/' . $data->id) . '\');" data-content="' .
                        trans('users/lang.suplantar') . '" data-placement="right" data-toggle="popover">
                        <i class="fas fa-user-secret" aria-hidden="true"></i></button>';
                }
                return $actions;
            })
            ->removeColumn('id')
