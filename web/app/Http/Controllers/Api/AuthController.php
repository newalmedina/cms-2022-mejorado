...
class AuthController extends ApiController
{
     ...
     *                     format="password"
     *                 ),
     *                 example={"email": "ing.newal.medina@outlook.com", "password": "secret"}
     *             )
     *         )
     *     ),
     *     @OA\Response(
    ...
    public function signin(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $token = auth()->user()->createToken(self::APITOKEN)->plainTextToken;
        } catch (\Exception $e) {
    ...
    public function changePassword(Request $request): JsonResponse
    {
        ...
        $rules = [
            ...
            'new_password' => 'required|min:4|string|max:255'
        ];
        $validator = Validator::make($credentials, $rules);
        if ($validator->fails()) {
            return $this->respondWithCode(Response::HTTP_UNAUTHORIZED);
