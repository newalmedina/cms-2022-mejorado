...
class BaseServiceProvider extends ServiceProvider
{
    ...
    protected function init($resources_dir, $nameSpace)
    {
        ...
        if (!$this->app->routesAreCached()) {
            $route_files = [
                ...
                $resources_dir . '/routes/auth.php',
                $resources_dir . '/routes/web.php',
                $resources_dir . '/routes/api.php',
                $resources_dir . '/routes/channels.php',
            ];
        ...
        Blade::componentNamespace($nameSpace. '\\Components', $this->module);
    }
    ...
    */
    ...
    protected function publish($resources_dir, $config_file_name = "")
    {
        ...
        $this->publishes([
            $resources_dir.'/../database/seeders' => database_path('seeders')
        ], 'seeds');
        $this->publishes([
