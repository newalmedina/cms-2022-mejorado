        ...
        <div class="col-12">
            <div class="card card-secondary card-outline">
                <div class="card-header with-border">
                    <h3 class="card-title">{{ trans('Centers::centers/admin_lang.listado') }}</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="float-right">
                        @if(Auth::user()->isAbleTo("admin-centers-create"))
                            <a href="{{ url('admin/centers/create') }}" class="btn btn-success float-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('Centers::centers/admin_lang.nueva') }}</a>
                        @endif
                    </div>
                </div>
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="table_centers" class="table table-bordered table-striped" aria-hidden="true">
                        <thead>
                        <tr>
                            <th scope="col">
                            <th scope="col">
...
<th scope="col">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header"><h3 class="card-title">{{ trans("Centers::centers/admin_lang.export") }}</h3></div>
            <div class="card-body">
                <a href="{{ url('admin/centers/export') }}" class="btn btn-app">
                    <i class="far fa-file-excel" aria-hidden="true"></i>
                    {{ trans('Centers::centers/admin_lang.exportar_datos') }}
                </a>
            </div>
        </div>
    </div>
...
@section("foot_page")
    ...
    <script type="text/javascript">
        ...
        $(function () {
            oTable = $('#table_centers').DataTable({
                "stateSave": true,
                "stateDuration": 60,
                "processing": true,
                "serverSide": true,
                ...
                columns: [
                    ...
                    {
                        "title"         : "{!! trans('Centers::centers/admin_lang.fields.active') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'active',
                        sWidth          : '50px'
                        ...
                        {
                                "title"         : "{!! trans('Centers::centers/admin_lang.fields.name') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'name',
                                name            : 'c.name',
                        ...
                        ,
                        {
                                "title"         : "{!! trans('Centers::centers/admin_lang.fields.phone') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'phone',
                                name            : 'c.phone',
                        ...
                        ,
                        {
                                "title"         : "{!! trans('Centers::centers/admin_lang.fields.email') !!}",
                                orderable       : true,
                                searchable      : true,
                                data            : 'email',
                                name            : 'c.email',
                        ...
                        ,
                    {
                        "title"         : "{!! trans('Centers::centers/admin_lang.acciones') !!}",
                        orderable       : false,
                        searchable      : false,
                        sWidth          : '110px',
                        data            : 'actions'
            ...
            $('tfoot th',$('#table_centers')).each( function (colIdx) {
                var title = $('tfoot th',$('#table_centers')).eq( $(this).index() ).text();
            ...
            $('#table_centers').on( 'keyup change','tfoot input', function (e) {
                oTable
    ...
    $.ajax({
        ...
        $('#table_centers tbody').on('change', 'input[type="checkbox"]', function(){
        ...
        function deleteSelected() {
            ...
            if(ids.length>0){
                deleteElements('{{ url('admin/centers/delete-selected') }}', ids);
            }
        }

        function getSelectedRecords() {
            var ids = [];
            $('#table_centers input[type="checkbox"]').each(function(){
