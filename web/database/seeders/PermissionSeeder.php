...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Front de centros
        $adminRole = new Permission();
        $adminRole->display_name = 'Centros';
        $adminRole->name = Str::slug('frontend-centros');
        $adminRole->description = 'Centros - Módulo';
        $adminRole->save();
        $childWebCentros = $this->childWeb->children()->create(['permissions_id' => $adminRole->id]);
        $this->a_permission_admin[] = $adminRole->id;

        $adminRole = new Permission();
        $adminRole->display_name = 'Centros - Cambiar centro';
        $adminRole->name = Str::slug('frontend-centros-change');
        $adminRole->description = 'Centros - Cambiar centro';
        $adminRole->save();
        $childWebCentros->children()->create(['permissions_id' => $adminRole->id]);
        $this->a_permission_admin[] = $adminRole->id;
