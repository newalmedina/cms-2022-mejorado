...
chmod +x sonar-scanner-cli-4.6.0.2311-linux/bin/sonar-scanner

ln -s /opt/sonarscanner/sonar-scanner-cli-4.6.0.2311-linux/bin/sonar-scanner /usr/local/bin/sonar-scanner

pwd

ls -lisa

chmod 777 sonar-scanner-cli-4.6.0.2311-linux/conf/sonar-scanner.properties
