        ...
        <div class="col-12">
            <div class="card card-default">
                <div class="card-header with-border">
                    <h3 class="card-title">{{ trans("crud-generator::fields/admin_lang.list"). " - ".$module->title }}</h3>
                </div>

                <div class="card-body">
                    <a href="{{ url('admin/crud-generator') }}" class="btn btn-info float-left"><i class="fa fa-backward" aria-hidden="true"></i> {{ trans('crud-generator::fields/admin_lang.back') }}</a>


                    @if(Auth::user()->isAbleTo("admin-modulos-crud-create"))
                        <a href="{{ url('admin/crud-generator/'.$module->id.'/fields/create') }}" class="btn btn-success float-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('crud-generator::fields/admin_lang.new') }}</a>
                        <button  onclick="javascript:CreateAll('{{ url('admin/crud-generator/'.$module->id.'/fields/createfull') }}');" class="btn btn-warning float-right margin-right-lg mr-3"><i class="fa fa-list-alt" aria-hidden="true"></i> {{ trans('crud-generator::fields/admin_lang.new_full') }}</button>
                        <a href="{{ url('admin/crud-generator/'.$module->id.'/fields/grid') }}" class="btn btn-secondary float-right margin-right-lg mr-3"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('crud-generator::fields/admin_lang.grid_order') }}</a>
                        <a href="{{ url('admin/crud-generator/'.$module->id.'/fields/table') }}" class="btn bg-purple float-right margin-right-lg mr-3"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('crud-generator::fields/admin_lang.table_order') }}</a>
