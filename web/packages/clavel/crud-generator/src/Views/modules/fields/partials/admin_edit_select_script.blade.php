...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#addRow').on( 'click', function (event) {
            ...
            oTable.row.add( [
                '<input placeholder="Valor" class="form-control input-xlarge" style="width: 100% !important;" id="select_data[]" name="select_data[]" type="text">',
                '<input placeholder="Texto" class="form-control input-xlarge" style="width: 100% !important;" id="select_value[]" name="select_value[]" type="text">',
