...
<div class="card card-primary">
    <div class="card-header  with-border"><h3 class="card-title">{{ trans("crud-generator::fields/admin_lang.extra_options") }} - Select</h3></div>
    <div class="card-body">
            ...
            <tbody>
                @if(!empty($field->data))
                    @foreach(json_decode($field->data) as $select)
                        <tr>
                            <td>
                                {!! Form::text('select_data[]', $select[0],
                            ...
                            <td>
                                {!! Form::text('select_value[]', $select[1],
