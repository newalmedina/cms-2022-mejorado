...
use Clavel\CrudGenerator\Services\CrudGenerator\CrudMenu;
...
class CrudGenerator
{
    ...
    {
        $this->resourcePath = __DIR__ . '/../../resources/stubs/';
        ...
        $this->crudMenu = new CrudMenu($this);
    }
    ...
    public function generateAll(Module $module, $generate = [])
    {
        try {
            ...
            // Theme
            $this->resourcePath = $this->resourcePath.$this->module->theme->slug."/";
    ...
    protected function clean(Module $module)
    {
        ...
        $seederFile = database_path('seeders') . DIRECTORY_SEPARATOR . $module->modelPlural . 'PermissionSeeder.php';
