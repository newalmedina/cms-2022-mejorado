...
class CrudRequest
{
    ...
    protected function request(Module $module)
    {
                ...
                if ($field->is_multilang) {
                    if ($field->is_required) {
                        ...
                        $messagesArray[] = '\'lang.\'.$this->locale.\'.' . $field->column_name .
                            ...
                            '{{modelNamePluralLowerCase}}/' . $this->moduleTypeLowerCase . '_lang.fields.' .
        ...
        $adminOrFront = Str::ucfirst(strtolower($module->type->slug));
        file_put_contents(
            $requestsDirectory . DIRECTORY_SEPARATOR . $adminOrFront . $module->modelPlural . "Request.php",
            $requestTemplate
        );
    }
}
