    ...
    protected function controller(Module $module)
    {
        ...
        if ($hasLang) {
            ...
            $fieldTemplate = str_replace(
                ...
                $this->crudGenerator->getStub($fieldPath)
            );
        ...
        if ($hasActive) {
            ...
            $activeColumnData = str_replace(
                ...
                $this->crudGenerator->getStub($activePath)
            );
                    ...
                    case "checkbox":
                            $editColumnData .= '
                                $table->editColumn(\'' . $field->column_name . '\', function ($row) {
                                    ...
                                    return \'<i class="fa fa-times text-red" aria-hidden="true"></i>\';
                                });
                            ';
                            $rawColumns .= "'" . $field->column_name . "', ";
                        break;
                    case "select":
                        $editColumnData .= '
                            $table->editColumn(\'' . $field->column_name . '\', function ($row) {
        ...
        file_put_contents($controllerDirectory . DIRECTORY_SEPARATOR . $this->moduleTypeUpperCase .
