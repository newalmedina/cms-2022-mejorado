        ...
        <div class="col-12">
            ...
            <div class="card card-secondary card-outline">
                <div class="card-header with-border">
                    <h3 class="card-title">{{ trans("basic::menu/admin_lang.listado_menu") }}</h3>
                </div>

                <div class="card-body">
                    @if(Auth::user()->isAbleTo("admin-menu-create"))
                        <a href="{{ url('admin/menu/create') }}" class="btn btn-success float-right"><i class="fa fa-plus-circle" aria-hidden="true"></i> {{ trans('basic::menu/admin_lang.nuevo_menu') }}</a>
                        @endif
                </div>

                <div class="card-body">

                    <table id="table_menus" class="table table-bordered table-striped" aria-hidden="true">
                        <thead>
                        <tr>
                            <th scope="col"></th>
                            <th scope="col"></th>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            oTable = $('#table_menus').DataTable({
                ...
                columns: [
                    {
                        "title"         : "{!! trans('basic::menu/admin_lang.principal') !!}",
                        orderable       : false,
                        searchable      : false,
                        data            : 'primary',
                        sWidth          : '50px'
                    ...
                    {
                        "title"         : "{!! trans('basic::menu/admin_lang.nombre_menu') !!}",
                        orderable       : true,
                        searchable      : true,
                        data: 'name', name            : 'name',
                        sWidth          : ''
                    ...
                    {
                        "title"         : "{!! trans('basic::menu/admin_lang.acciones') !!}",
                        orderable       : false,
                        searchable      : false,
                        data: 'actions',
                        sWidth          : '110px'
