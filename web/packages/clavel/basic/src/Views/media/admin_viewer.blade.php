    ...
    <div id="multimedia" class="row">
        <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
                ...
                @endif
                <div id="listOfFolders" class="card-body" style="height: 425px; overflow: hidden; overflow-y: auto;">
                    <ul class="nav nav-pills nav-stacked">
                        <li id="li_root" class="active list_folder">
                            <a href="javascript:changeFolder('/', 'root');">
                                <i id="fa_root" class="fa fa-folder-open text-secondary fa-icon_f" aria-hidden="true"></i>/
                            </a>
                        </li>
                        @foreach($subfolders as $key => $value)
                            <li id="li_{{ $key }}" class="list_folder">
                                <a href="javascript:changeFolder('{{ $value }}', '{{$key}}');">
                                    ...
                                    <i id="fa_{{ $key }}" class="fa fa-folder text-secondary fa-icon_f" aria-hidden="true"></i>
                                    {{ basename($value) }}
                                </a>
                            </li>
                        @endforeach
        ...
        <div class="col-md-9">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header with-border">
                    <h3 class="card-title">{{ trans("basic::media/admin_lang.files") }}</h3>
                </div>
                @if(Auth::user()->isAbleTo("admin-media-create"))
                    <div class="card-header with-border">
                ...
                @endif
                <div id="images_list" class="card-body" style="height: 425px; overflow: hidden; overflow-y: auto;">
