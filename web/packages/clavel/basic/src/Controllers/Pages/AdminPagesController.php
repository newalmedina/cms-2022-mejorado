...
class AdminPagesController extends AdminController
{
    ...
    public function index()
    {
        ...
        if (!auth()->user()->isAbleTo('admin-pages-list')) {
            app()->abort(403);
        }
    ...
    public function create()
    {
        ...
        $page_description = '<span class="badge badge-warning">' .trans('basic::pages/admin_lang.borrador') . '</span>';
        $form_data = array(
    ...
    public function edit($id)
    {
        ...
        if (!auth()->user()->isAbleTo('admin-pages-update')) {
            app()->abort(403);
        }
    ...
    public function destroy($id)
    {
        ...
        if (!auth()->user()->isAbleTo('admin-pages-delete')) {
            app()->abort(404);
        }
