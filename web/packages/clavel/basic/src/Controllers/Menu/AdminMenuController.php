...
class AdminMenuController extends AdminController
{
    ...
    public function index()
    {
        ...
        if (!auth()->user()->isAbleTo('admin-menu-list')) {
            app()->abort(403);
        }
    ...
    public function store(AdminMenuRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('menu.create')
                ->with('error', trans('basic::menu/admin_lang.error_en_accion'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if (!auth()->user()->isAbleTo('admin-menu-update')) {
            app()->abort(403);
        }
    ...
    public function destroy($id)
    {
        ...
        if (!auth()->user()->isAbleTo('admin-menu-delete')) {
            app()->abort(403);
        }
