...
class MenuSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $menuType->ico = "fas fa-external-link-alt";
        $menuType->save();
        $type_ids[$menuType->slug] = $menuType->id;
        ...
        // Ponenmos unos ejemplos de menus desplegables
        // Empresa
        $menuItem = MenuItem::create([
            'menu_id' => $menu_main_id,
            'item_type_id' =>  $type_ids["interno"],
        ...
        $menuItemChild3 = $menuItemChild->children()->create([
            'menu_id' => $menu_main_id,
            'item_type_id' => $type_ids["interno"],
            'status' => 1,
            'uri' => '/'
        ...
        $menu_translation = array(
            'menu_item_id' => $menuItemChild3->id,
            'locale' => "es",
            'title' => "Desplegable 1.2"
        );
        DB::table('menu_item_translations')->insertGetId($menu_translation);
